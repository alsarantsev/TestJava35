...
public class RandomPersonCreationAppl {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		/*
		 * it's a new method how to get link to bean in application context: create a new object from 
		 * ConfigurableApplicationContext, put on a our class and call method getBean from interface
		 * Person Repository
		 */
		ConfigurableApplicationContext ctx = SpringApplication.run(RandomPersonCreationAppl.class, args);
